...
- `nvidia-dkms` package removed when choosing Nvidia proprietary drivers. (`nvidia-470xx-dkms` should be installed manually from AUR.)
- Bootloader installation is skipped.
